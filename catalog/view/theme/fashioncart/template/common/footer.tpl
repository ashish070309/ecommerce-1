<div id="footer">
  ...
  <div class="big_column">
  	...
  	<a href='https://www.facebook.com/arihantgems?ref=hl' class='icon_facebook' title='Facebook'>Facebook</a>
       <a href='#' class='icon_tweet' title='Twitter'>Twitter</a>
  	<div class='clear'></div>
  	<div class='h20'></div>
  	<div class='h20'></div>
  	<div class='h20'></div>
...
<div id="powered"><a href="http://arihantgems.com" target="_blank">Arihant Gems & Jewels</a>  &copy; <?php echo date("Y");?>  &nbsp; |  &nbsp;  Developed By   <a href="http://upscale.co.in/" target="_blank"><img src="logo.png" width="50px" height="20px"></a><a href="http://rackspace.com/" target="_blank">  On <img src="rackspace_logo.jpg" width="50px" height="20px"></a>  With The Help Of <a href="http://opencart.com/" target="_blank">  <img src="opencart.png" width="80px" height="20px"></a></div>  
</div>
</div>
